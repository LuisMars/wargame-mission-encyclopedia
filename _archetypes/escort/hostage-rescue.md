---
id: escort.hostage-rescue
intent:
  primary: prisoner_transfer
interaction:
  primary: carry_state
victory:
  cadence: endgame
...
name:
  en: Hostage Rescue
  es: Rescate de rehenes
summary:
  en: Locate hostages held by the enemy and extract them by force.
  es: Localiza rehenes retenidos por el enemigo y extraelos por la fuerza.
...
- Flash and clear mechanics for room entry
...
- Mecanicas de entrada rápida para entrar en habitaciones
