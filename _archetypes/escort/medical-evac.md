---
id: escort.medical-evac
intent:
  primary: vip_escort
  secondary: evac_defense
interaction:
  primary: carry_state
victory:
  cadence: endgame
...
name:
  en: Medical Evac
  es: Evacuación medica
summary:
  en: Retrieve wounded and extract them from the battlefield.
  es: Recupera modelos heridos y extraelos del campo de batalla.
