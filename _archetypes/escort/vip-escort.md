...
name:
  ...
  es: Escolta de VIP
summary:
  en: Move a vulnerable VIP to safety across the battlefield.
  es: Mueve un VIP vulnerable a través del campo de batalla hasta un lugar seguro.
