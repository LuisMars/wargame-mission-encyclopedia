---
id: stealth.hidden-movement-hunt
intent:
  primary: hidden_movement
interaction:
  primary: detection_avoidance
victory:
  cadence: endgame
  win_form: binary
information:
...
spatial:
  ...
  dynamism: static
name:
  en: Hidden Movement Hunt
  es: Caza de movimiento oculto
summary:
  en: One side is concealed; the other searches. The quarry escapes or the hunter finds them.
  es: Un bando está oculto; el otro busca. La presa escapa o el cazador la encuentra.
tags: [contact-low, rules-heavy, asymmetric, slow]
---
...
- Time pressure forces risky moves
