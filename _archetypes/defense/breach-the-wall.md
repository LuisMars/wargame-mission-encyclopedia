...
match:
  ...
  symmetry: asymmetric
spatial:
  topology: chokepoints
  orientation: deep_enemy
  dynamism: static
name:
  en: Breach the Wall
  es: Abrir brecha en el muro
summary:
  en: Create an opening in the enemy defenses and hold the breach.
  es: Crea una apertura en las defensas enemigas y mantén la brecha.
