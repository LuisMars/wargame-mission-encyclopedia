---
id: defense.storm-the-strongpoint
intent:
  primary: siege_breach
  secondary: holdout_survival
interaction:
...
spatial:
  ...
  dynamism: static
name:
  en: Storm the Strongpoint
  es: Asaltar la posición fortificada
summary:
  en: Take a heavily fortified position by force.
  es: Toma una posición fuertemente fortificada por la fuerza.
tags: [contact-high, rules-med, asymmetric, slow]
---
