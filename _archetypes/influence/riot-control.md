...
name:
  en: Riot Control
  es: Control de disturbios
summary:
  en: Manage a volatile crowd to keep unrest under control.
  es: Gestiona una multitud volatil para mantener el desorden bajo control.
tags: [contact-med, rules-heavy, asymmetric, mid]
---
