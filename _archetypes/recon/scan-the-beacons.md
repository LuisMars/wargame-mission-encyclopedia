...
name:
  en: Scan the Beacons
  es: Escanear las balizas
summary:
  en: Interact with beacons to collect intel data.
  es: Interactua con balizas para recopilar datos de inteligencia.
