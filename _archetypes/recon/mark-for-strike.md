...
name:
  en: Mark for Strike
  es: Marcar para ataque
summary:
  en: Mark enemy positions or locations for off-board strikes.
  es: Marca posiciones enemigas o ubicaciones para ataques fuera del tablero.
