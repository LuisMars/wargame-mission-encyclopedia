---
id: recon.signal-triangulation
intent:
  primary: triangulate
  secondary: network_control
interaction:
...
spatial:
  ...
  dynamism: static
name:
  en: Signal Triangulation
  es: Triangulación de señal
summary:
  en: Control multiple signal relays simultaneously to triangulate.
  es: Controla múltiples relays de señal simultaneamente para triangular.
