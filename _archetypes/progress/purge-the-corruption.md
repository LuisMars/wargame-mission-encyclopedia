---
id: progress.purge-the-corruption
intent:
  primary: cleanse_convert
interaction:
  primary: interruptible_progress
victory:
  cadence: endgame
  win_form: threshold
information:
...
name:
  en: Purge the Corruption
  es: Purgar la corrupción
summary:
  en: Cleanse tainted nodes across the battlefield.
  es: Limpia nodos contaminados a lo largo del campo de batalla.
