...
name:
  en: Code Break
  es: Descifrar el codigo
summary:
  en: Collect code fragments and use them on a vault or terminal.
  es: Recopila fragmentos de codigo y usalos en una bóveda o terminal.
tags: [contact-med, rules-heavy, snowball-low, mid]
---
