---
id: progress.multi-switch-door
intent:
  primary: sequential_unlock
interaction:
...
spatial:
  ...
  dynamism: static
name:
  en: Multi-Switch Door
  es: Puerta de múltiples interruptores
summary:
  en: Hold multiple switches simultaneously to open a door and claim the objective beyond.
  es: Mantén múltiples interruptores simultaneamente para abrir una puerta y reclamar el objetivo detrás.
