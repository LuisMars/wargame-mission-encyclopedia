...
name:
  ...
  es: Asesinato
summary:
  en: One key model is the target; remove the enemy VIP to win.
  es: Un modelo clave es el objetivo; elimina al VIP enemigo para ganar.
