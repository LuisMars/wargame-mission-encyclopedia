...
match:
  player_count: ffa
  symmetry: symmetric
  third_party: kingmaker
spatial:
  topology: center_weighted
  orientation: midline
  dynamism: moving_objectives
name:
  en: Kingmaker Control
  es: Control del hacedor de reyes
summary:
  en: A rotating high-value objective forces conflict among multiple players.
  es: Un objetivo rotativo de alto valor fuerza el conflicto entre múltiples jugadores.
tags: [contact-high, rules-med, snowball-med, mid, multiplayer]
---
