...
name:
  ...
  es: Control de red
summary:
  en: Objectives form a graph where connectivity matters.
  es: Los objetivos forman un grafo donde la conectividad importa.
tags: [contact-med, rules-heavy, snowball-med, slow]
---
