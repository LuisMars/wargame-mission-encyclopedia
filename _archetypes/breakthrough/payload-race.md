...
name:
  ...
  es: Carrera de carga
summary:
  en: Push or drag a payload to the destination faster than the opponent.
  es: Empuja o arrastra una carga al destino más rápido qué el oponente.
